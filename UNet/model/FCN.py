...
class FCN32s(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.pretrained_net = VGGNet(pretrained=False, model='vgg16', requires_grad=True, remove_fc=True, show_params=True)
    ...
    def forward(self, x):
        ...
        return score,score  # size=(N, n_class, x.H/1, x.W/1)
...
#     assert output['x5'].size() == torch.Size([batch_size, 512, 7, 7])
    ...
    # fcn_model = FCN32s(n_class=n_class)
